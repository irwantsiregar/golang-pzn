...
func Upload(writer http.ResponseWriter, request *http.Request) {
	// request.ParseMultipartForm(32 << 20) // Func untuk custom default limit upload file (32 MB)
...
func TestUploadFile(t *testing.T) {
	...
	writer.WriteField("name", "Irwan Siregar")
	
	file, _ := writer.CreateFormFile("file", "contoh_upload.jpg")
